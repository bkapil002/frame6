...
export default function Navebar({setSidebarOpen }) {
  ...
  useEffect(() => {
    ...
    if (user?.token) {
      fetch("http://localhost:5000/api/tokenEXP", {
        method: "GET",
        headers: {
          Authorization: `Bearer ${user.token}`,
        },
                    ...
                    >
                      <div className="px-2 py-4 border-b border-gray-200 text-black text-[14px] font-semibold">
                        <Link
                          ...
                          className="flex px-3 -mt-2 py-2 mb-1 items-center place-content-between bg-[#f5f5f5] hover:bg-[#272974] hover:text-white cursor-pointer rounded-[10px]"
                        >
                          {user?.name || "User"}
                          <img
                            src={
          ...
          >
            ...
            <div className="flex justify-between items-center p-4 px-2">
              <div className="w-full   border-gray-200 text-black text-[14px] ">
                <Link
                  to={`https://community.samzara.in/${user.name}`}
                  className="flex px-4.5 font-bold -mt-2 py-1.5 items-center place-content-between bg-[#f5f5f5] hover:bg-[#272974] hover:text-white cursor-pointer rounded-[10px]"
                >
            ...
            <ul className=" px-7 space-y-3  text-[#828282] font-medium text-[15px]">
              <a
                href="https://community.samzara.in/search"
              ...
              <a
                href="https://community.samzara.in/setting"
                className="flex items-center gap-4 cursor-pointer"
              >
                <svg viewBox="0 0 24 24" width="18" height="18" color="#666">
                  <path
